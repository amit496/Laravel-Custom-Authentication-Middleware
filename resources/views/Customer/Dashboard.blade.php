...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-9">
            ...
            <div class="card">
                <div class="card-body"><iframe class="chartjs-hidden-iframe" style="width: 100%; display: block; border: 0px; height: 0px; margin: 0px; position: absolute; inset: 0px;"></iframe>
                    ...
                    <canvas id="lineChart" height="201" width="739" style="width: 739px; height: 201px;"></canvas>
                </div>
            </div>
        </div>
        <div class="col-lg-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <div><iframe class="chartjs-hidden-iframe" style="width: 100%; display: block; border: 0px; height: 0px; margin: 0px; position: absolute; inset: 0px;"></iframe>
                        <canvas id="dash-doughnut" height="133" width="200" style="width: 200px; height: 133px;"></canvas>
                    </div>
        ...
        <div class="col-xl-4 col-lg-6">
            <div class="card">
                <div class="card-body"><iframe class="chartjs-hidden-iframe" style="width: 100%; display: block; border: 0px; height: 0px; margin: 0px; position: absolute; inset: 0px;"></iframe>
                    ...
                    <canvas id="bar-data" height="127" width="290" style="width: 290px; height: 127px;"></canvas>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
